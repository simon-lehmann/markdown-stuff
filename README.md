...
Personal skills I use in my day-to-day agentic development workflows. Built for the [vercel-labs/skills](https://github.com/vercel-labs/skills) CLI.
...
```bash
npx skills add simon-lehmann/markdown-stuff
```
